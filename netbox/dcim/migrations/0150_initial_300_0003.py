...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tenancy', '0150_initial_300'),
        ('extras', '0150_initial_300_0002'),
        ('dcim', '0150_initial_300_0002'),
        ('contenttypes', '0002_remove_content_type_name'),
        ('ipam', '0150_initial_300'),
        ('virtualization', '0150_initial_300'),
    ]
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(
            name='device',
            unique_together={('site', 'tenant', 'name'), ('virtual_chassis', 'vc_position'), ('rack', 'position', 'face')},
        ),
        migrations.AlterUniqueTogether(
